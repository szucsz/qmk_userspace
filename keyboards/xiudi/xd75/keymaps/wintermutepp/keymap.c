...
//                                                       ||||||||                                                    ||||||||
    [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
        ...
        KC_LSFT,       KC_Z,     KC_X,       KC_C,       KC_V,       KC_B,         KC_MINS,    KC_BSLS,  KC_N,       KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,     KC_UP,     KC_END,
        KC_LCTL,       KC_LGUI,  KC_LALT,    TT(_UP),    KC_SPC,     NV(KC_BSPC),  KC_TAB,     KC_ENT,   KC_SPC,     KC_DEL,   TT(_UP),  KC_HOME,  KC_LEFT,     KC_DOWN,   KC_RGHT
    ),
    [_CO] = LAYOUT_ortho_5x15( /* Colemak DH */
        ...
        KC_LSFT,       KC_Z,     KC_X,       KC_C,       KC_D,       KC_V,         KC_MINS,    KC_BSLS,  KC_K,       KC_H,     KC_COMM,  KC_DOT,   KC_SLSH,     KC_UP,     KC_END,
        KC_LCTL,       KC_LGUI,  KC_LALT,    MO(_UP),    KC_SPC,     NV(KC_BSPC),  KC_TAB,     KC_ENT,   KC_SPC,     KC_DEL,   MO(_UP),  KC_HOME,  KC_LEFT,     KC_DOWN,   KC_RGHT
    ),
    [_UP] = LAYOUT_ortho_5x15( /* FUNCTION */
        ...
        _______,       _______,  _______,    TT(_UP),    _______,    _______,      RGB_RMOD,   RGB_MOD,  _______,    _______,  TT(_UP),  _______,  KC_HOME,     KC_PGDN,   KC_END
    ),
    [_NV] = LAYOUT_ortho_5x15( /* NAVIGATION */
        ...
        C(KC_GRV),     M_01,     C(KC_LEFT), KC_UP,      C(KC_RGHT), KC_INS,       _______,    _______,  _______,    KC_P7,    KC_P8,    KC_P9,    _______,     _______,   _______,
        _______,       KC_HOME,  KC_LEFT,    KC_DOWN,    KC_RGHT,    KC_END,       _______,    _______,  QK_LEAD,    KC_P4,    KC_P5,    KC_P6,    KC_P0,       _______,   _______,
        _______,       C(KC_Z),  C(KC_X),    C(KC_INS),  S(KC_INS),  KC_APP,       _______,    _______,  _______,    KC_P1,    KC_P2,    KC_P3,    _______,     _______,   _______,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) { // This will do most of the grunt work with the keycodes.
        ...
        case LT(0,KC_C):
            if (!record->tap.count && record->event.pressed) {
                tap_code16(C(KC_INS)); // Intercept hold function to send Ctrl-C
                return false;
            }
            return true;             // Return true for normal processing of tap keycode
        case LT(0,KC_V):
            if (!record->tap.count && record->event.pressed) {
                tap_code16(S(KC_INS)); // Intercept hold function to send Ctrl-V
                return false;
            }
            return true;             // Return true for normal processing of tap keycode
        case CC_QWER:
...
void leader_end_user(void) {
    if (leader_sequence_one_key(KC_T)) {
        SEND_STRING("t519623");
    } else if (leader_sequence_two_keys(KC_A, KC_QUOT)) {
        SEND_STRING("a");
    }
}
