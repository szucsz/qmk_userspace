...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [L_IB] = LAYOUT(
        ...
        KC_LCTL,   KC_LALT,   KC_RGUI,   KC_ESC,    KC_TAB,  IF(KC_BSPC),     IS(KC_SPC),   KC_DEL,   KC_VOLD,   KC_VOLU,   XXXXXXX,  KC_BSLS
    ),
    ...
    [L_WB] = LAYOUT(
        ...
        KC_Z,      KC_X,      KC_C,      KC_V,      KC_B,       KC_GRV,          KC_QUOT,   KC_N,     KC_M,      KC_COMM,   KC_DOT,   KC_SLSH,
        KC_LGUI,   KC_LALT,   KC_LCTL,   KC_ESC,    KC_TAB,  WF(KC_BSPC),     WS(KC_SPC),   KC_DEL,   KC_VOLD,   KC_VOLU,   SC(KC_M), KC_BSLS
    ),
